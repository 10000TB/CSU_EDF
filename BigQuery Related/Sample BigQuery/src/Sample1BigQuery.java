...
public class Sample1BigQuery {
  ...
  private static final String CLIENTSECRETS_LOCATION = "C:/Users/pinkmaggot/Desktop/Test/OAuth/clients_secrets.json";
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    listDatasets(bigquery, "csumssummerproject");

    // Start a Query Job
    String querySql = "SELECT COUNT(*) FROM csumssummerproject:TEST.TEST_STU";
    ...
    String querySql1 = "SELECT NAME FROM csumssummerproject:TEST.TEST_STU WHERE AGE=18";
    JobReference jobId1 = startQuery(bigquery, PROJECT_ID, querySql1);

    // Poll for Query Results, return result output
    Job completedJob1 = checkQueryResults(bigquery, PROJECT_ID, jobId1);

    // Return and display the results of the Query Job
    displayQueryResults(bigquery, PROJECT_ID, completedJob1);
