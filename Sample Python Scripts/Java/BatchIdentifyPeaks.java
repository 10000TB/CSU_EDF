 ...
 * Added 2015/06/02: The program has been tested and confirmed as working properly.
 * 
...
public class BatchIdentifyPeaks {
	...
	static String myDir = "C:/Users/pinkmaggot/Desktop/Test/testout/";
	static 
	...
	private static boolean IdentifyPeaks(String xCar, String xDate,	String xDir, String xFilename) {
		...
		try{
			...
			fOutWriter.write("PEAK_NUM,FRACHRSTART,"+fieldName1+","+fieldName2+",WKT"+",LON,LAT,CH4_BASELINE,PEAK_DIST_M,PEAK_CH4,PERIOD5MIN\n");
